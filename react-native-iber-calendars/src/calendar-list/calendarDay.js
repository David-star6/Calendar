...
class calendarDay extends Component {
    ...
    renderTouchableItem(item) {
        ...
        >
            {this.props.select == item.day ? <View style={{ opacity: this.props.isShowLcd ? 0.1 : 1, position: 'absolute', top: this.props.itemSizeHeight / 12, borderRadius: this.itemSize / 2, width: this.itemSize, height: this.itemSize, backgroundColor: this.props.selectDayColor }}></View> : null}
