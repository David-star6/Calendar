...
export const lcdSize = 9
export const textSize = 15

export const festivalColor = '#666666'
export const selectDayColor = '#3364E4';
export const signActionColor = '#FF3A3A';
export const signInavalidColor = '#BABABA';
export const textColor = '#2A2A2A';
export const lcdColor = '#A5A5A5';
export const textSelectColor = '#FFFFFF'
